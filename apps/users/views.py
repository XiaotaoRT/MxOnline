...
class SendEmailCoudeView(LoginRequiredMixin, View):
    """
    发送邮箱验证码
    """
    def get(self, request):
...
class UpdateEmailCoudeView(LoginRequiredMixin, View):
    """
    修改个人邮箱
    """
    def post(self, request):
...
class IndexView(View):
    ...
    def get(self, request):
        ...
        banner_course = Courses.objects.filter(is_banner=True)[:3]
